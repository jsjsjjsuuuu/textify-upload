...
- يمكن أن يكون الكود رقماً أو مزيجاً من أرقام وحروف.`;
}
...
تأكد من استخراج كل النصوص المكتوبة بخط اليد والنصوص الصغيرة بدقة.`;
}
...
- أرقام الهواتف والتواريخ

اهتم بشكل خاص بالتالي:
- رقم الوصل أو الكود (عادة يبدأ بـ # أو يتبع كلمة "رقم")
- رقم الهاتف (خاصة إذا كان يبدأ بـ 07)
- أسماء الأشخاص
- أسماء المحافظات العراقية
- المبالغ والأسعار
- أسماء الشركات
- أرقام غريبة أو غير منتظمة

ثم ضع البيانات التي استطعت استخراجها في صيغة JSON.`;
}
...
بعد اكتشاف النصوص، حاول أن تنظم البيانات في صيغة JSON بهذا الشكل:
...
اكتشف رقم الهاتف العراقي: يجب أن يكون 11 رقم ويبدأ بـ 07.
اكتشف الكود: عادة ما يكون رقماً قصيراً أو متوسط الطول (4-10 أرقام).
اكتشف المحافظة: اسم محافظة عراقية مثل بغداد، البصرة، أربيل، الموصل، الخ.`;
}
