...
const HomePage = () => {
  ...
  const timelineItems = [
    {
      year: '2024',
      title: 'توسيع خدمات الذكاء الاصطناعي',
      description: 'تطوير حلول متقدمة لاستخراج البيانات من الصور',
      items: [
        'دعم المزيد من تنسيقات الصور',
        'تحسين دقة التعرف على النصوص',
        'إضافة خوارزميات ذكاء اصطناعي متطورة'
      ]
    },
    {
      year: '2023',
      title: 'إطلاق منصة استخراج البيانات',
      description: 'بناء منصة متكاملة لمعالجة وتحليل الصور',
      items: [
        'واجهة مستخدم سهلة وبديهية',
        'دعم معالجة صور متعددة بنفس الوقت',
        'أتمتة عمليات إدخال البيانات'
      ]
    },
    {
      year: 'أوائل 2023',
      title: 'بداية رحلة الابتكار',
      description: 'تأسيس الفكرة الأولية وتطوير النموذج الأساسي',
      items: [
        'تحديد التحديات في استخراج البيانات',
        'تطوير أول نموذج للذكاء الاصطناعي',
        'بناء فريق متخصص في معالجة البيانات'
      ]
    }
  ];
