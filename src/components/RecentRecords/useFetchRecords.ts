        ...
        setTimeout(() => {
          ...
          resolve([
            ...
            },
            {
              ...
              province: 'البصرة',
              date: new Date(Date.now() - 86400000), // يوم واحد قبل اليوم
              status: 'pending',
              price: '35000',
              file: createDummyFile(),
              previewUrl: 'https://via.placeholder.com/150',
            ...
            },
            {
              ...
              province: 'أربيل',
              date: new Date(Date.now() - 172800000), // يومين قبل اليوم
              status: 'processing',
              price: '75000',
              file: createDummyFile(),
              previewUrl: 'https://via.placeholder.com/150',
            ...
            },
            {
              ...
              province: 'الموصل',
              date: new Date(Date.now() - 259200000), // ثلاثة أيام قبل اليوم
              status: 'error',
              price: '60000',
              file: createDummyFile(),
              previewUrl: 'https://via.placeholder.com/150',
