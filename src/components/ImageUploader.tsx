          ...
          {isProcessing ? <>
              ...
              <div className="relative w-16 h-16 mb-2">
                ...
                scale: 0.8
                    ...
                    {isDragging ? <FileImage className="w-14 h-14 text-primary" /> : <Upload className="w-14 h-14 text-gray-400 dark:text-gray-600" />}
                  </motion.div>
                </AnimatePresence>
              </div>
              <h3 className="text-xl font-semibold text-gray-700 dark:text-gray-300">
              ...
              {useGemini && <p className="text-xs text-primary mt-2">
          </p>}
            </>}
        </div>
      </div>
